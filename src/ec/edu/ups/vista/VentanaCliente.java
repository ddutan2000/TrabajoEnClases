...
public class VentanaCliente extends javax.swing.JInternalFrame {
    ...
    public VentanaCliente(ControladorPersona controladorPersona, ControladorRegex controladorRegex) {
        initComponents();
    ...
    public void limpiar(){
        ...
        public void ActualizarVista(List<Cliente> clientes) {
        ...
        if (!txtCedula.getText().isEmpty() && !txtNombre.getText().isEmpty() && !txtApellido.getText().isEmpty()
            ...
            if (vCedula) {
                ...
                if (vTelefono) {
                    ...
                    controladorP.createCliente(cedula, nombre, apellido, fecha, direccion, telefono);
